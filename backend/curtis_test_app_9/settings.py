"""
Django settings for curtis_test_app_9 project.
...
ROOT_URLCONF = 'curtis_test_app_9.urls'
...
WSGI_APPLICATION = 'curtis_test_app_9.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "curtis_test_app_9 API",
    "DESCRIPTION": "API documentation for curtis_test_app_9 App",
    "VERSION": "v1",
}
